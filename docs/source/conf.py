...
.. |link_voice_options| raw:: html
    ...
    <a href="https://platform.openai.com/docs/guides/text-to-speech/voice-options" target="_blank">Opciones de voz</a>
...
.. |link_openai_platform| raw:: html
    ...
    <a href="https://platform.openai.com/api-keys" target="_blank">OpenAI Plataforma</a>

.. |link_microphone| raw:: html

    <a href="https://www.sunfounder.com/products/mini-usb-microphone?_pos=2&_sid=d05c80026&_ss=r" target="_blank">Enlace de micrófono</a>
...
.. |link_PiCar-X_kit| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/picar-x?variant=44269165510891" target="_blank">Enlace de compra para PiCar-X Kit</a>
